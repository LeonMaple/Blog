...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6fa63d59adce07a7aa19cdfbd3efe0d8e7e9d401222289e9ac7866e6f5623225');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Blog/Bundle/Resources/views'), 'Blog');
        $instance->addPath(($this->targetDirs[3].'/src/Blog/WebBundle/Resources/views'), 'BlogWeb');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BlogBundle' => 'Blog\\Bundle\\BlogBundle',
                'BlogWebBundle' => 'Blog\\WebBundle\\BlogWebBundle',
